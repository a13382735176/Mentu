...
# 数据加载和处理
data_path = '/root/try pretrained/dataset/preprocessed/HDFS/Modified_hdfs_log_structed_with_translated_event.csv'
...
embeddings_path = '/root/try pretrained/dataset/preprocessed/HDFS/modified_dim400_embeddings.npy'
