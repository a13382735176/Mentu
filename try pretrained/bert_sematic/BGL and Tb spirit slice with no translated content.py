...
# Example usage:
file_path = '/root/try pretrained/dataset/preprocessed/BGL/Modified_BGL_log_structed_with_translated_event.csv'
# Example usage:'
output_path = '/root/try pretrained/dataset/preprocessed/BGL/20l_BGL.csv'
